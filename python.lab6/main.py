...
# допомогою функції input ми отримуємо це значення у формі строки, але
...
# "get_result" - це сума тих пар, які задовільняють нерівності
...
# буде повторбватися до тих пір до поки другий цикл while не поверне значення false,
...
# Підсумок : за допомогою цієї задачі я покращив свої навички у використовувані циклів,
